...
public enum BotMessage {
    ...
    BRIEFING_MESSAGE(emoji(":information_source:") + " " + "Технология партия существует благодаря формуле «разделяй и властвуй», только с миловидным предлогом «плюрализм мнений».⠀\n" +
            ...
            "⠀\n" +
            "Например, чтобы не собирать голоса для выдвижения своего кандидата от той или иной партии, ей необходимо хотя бы в каком-либо законодательном собрании любого региона РФ набрать на выборах 5%. ⠀\n" +
            "Таких партий в России 13! Вы знаете все? А знаете почему вы их не знаете, потому что политику нельзя рекламировать. Это закрытый клуб и значит это выгодно! Так а чё вы сидите? ⠀\n" +
            "⠀\n" +
